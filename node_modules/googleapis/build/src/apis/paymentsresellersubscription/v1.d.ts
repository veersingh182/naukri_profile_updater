...
export declare namespace paymentsresellersubscription_v1 {
    ...
    export class Resource$Partners$Products {
        ...
        list(params?: Params$Resource$Partners$Products$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListProductsResponse>>;
        ...
        list(params: Params$Resource$Partners$Products$List, options: MethodOptions | BodyResponseCallback<Schema$ListProductsResponse>, callback: BodyResponseCallback<Schema$ListProductsResponse>): void;
        list(params: Params$Resource$Partners$Products$List, callback: BodyResponseCallback<Schema$ListProductsResponse>): void;
    ...
    export class Resource$Partners$Promotions {
        ...
        findEligible(params?: Params$Resource$Partners$Promotions$Findeligible, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FindEligiblePromotionsResponse>>;
        ...
        findEligible(params: Params$Resource$Partners$Promotions$Findeligible, options: MethodOptions | BodyResponseCallback<Schema$FindEligiblePromotionsResponse>, callback: BodyResponseCallback<Schema$FindEligiblePromotionsResponse>): void;
        findEligible(params: Params$Resource$Partners$Promotions$Findeligible, callback: BodyResponseCallback<Schema$FindEligiblePromotionsResponse>): void;
        findEligible(callback: BodyResponseCallback<Schema$FindEligiblePromotionsResponse>): void;
        /**
        ...
        list(params?: Params$Resource$Partners$Promotions$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListPromotionsResponse>>;
        ...
        list(params: Params$Resource$Partners$Promotions$List, options: MethodOptions | BodyResponseCallback<Schema$ListPromotionsResponse>, callback: BodyResponseCallback<Schema$ListPromotionsResponse>): void;
        list(params: Params$Resource$Partners$Promotions$List, callback: BodyResponseCallback<Schema$ListPromotionsResponse>): void;
    ...
    export class Resource$Partners$Subscriptions {
        ...
        cancel(params?: Params$Resource$Partners$Subscriptions$Cancel, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$CancelSubscriptionResponse>>;
        ...
        cancel(params: Params$Resource$Partners$Subscriptions$Cancel, options: MethodOptions | BodyResponseCallback<Schema$CancelSubscriptionResponse>, callback: BodyResponseCallback<Schema$CancelSubscriptionResponse>): void;
        cancel(params: Params$Resource$Partners$Subscriptions$Cancel, callback: BodyResponseCallback<Schema$CancelSubscriptionResponse>): void;
        cancel(callback: BodyResponseCallback<Schema$CancelSubscriptionResponse>): void;
        /**
        ...
        create(params?: Params$Resource$Partners$Subscriptions$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Subscription>>;
        ...
        create(params: Params$Resource$Partners$Subscriptions$Create, options: MethodOptions | BodyResponseCallback<Schema$Subscription>, callback: BodyResponseCallback<Schema$Subscription>): void;
        create(params: Params$Resource$Partners$Subscriptions$Create, callback: BodyResponseCallback<Schema$Subscription>): void;
        ...
        entitle(params?: Params$Resource$Partners$Subscriptions$Entitle, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EntitleSubscriptionResponse>>;
        ...
        entitle(params: Params$Resource$Partners$Subscriptions$Entitle, options: MethodOptions | BodyResponseCallback<Schema$EntitleSubscriptionResponse>, callback: BodyResponseCallback<Schema$EntitleSubscriptionResponse>): void;
        entitle(params: Params$Resource$Partners$Subscriptions$Entitle, callback: BodyResponseCallback<Schema$EntitleSubscriptionResponse>): void;
        entitle(callback: BodyResponseCallback<Schema$EntitleSubscriptionResponse>): void;
        /**
        ...
        extend(params?: Params$Resource$Partners$Subscriptions$Extend, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ExtendSubscriptionResponse>>;
        ...
        extend(params: Params$Resource$Partners$Subscriptions$Extend, options: MethodOptions | BodyResponseCallback<Schema$ExtendSubscriptionResponse>, callback: BodyResponseCallback<Schema$ExtendSubscriptionResponse>): void;
        extend(params: Params$Resource$Partners$Subscriptions$Extend, callback: BodyResponseCallback<Schema$ExtendSubscriptionResponse>): void;
        extend(callback: BodyResponseCallback<Schema$ExtendSubscriptionResponse>): void;
        /**
        ...
        get(params?: Params$Resource$Partners$Subscriptions$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Subscription>>;
        ...
        get(params: Params$Resource$Partners$Subscriptions$Get, options: MethodOptions | BodyResponseCallback<Schema$Subscription>, callback: BodyResponseCallback<Schema$Subscription>): void;
        get(params: Params$Resource$Partners$Subscriptions$Get, callback: BodyResponseCallback<Schema$Subscription>): void;
        ...
        provision(params?: Params$Resource$Partners$Subscriptions$Provision, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Subscription>>;
        ...
        provision(params: Params$Resource$Partners$Subscriptions$Provision, options: MethodOptions | BodyResponseCallback<Schema$Subscription>, callback: BodyResponseCallback<Schema$Subscription>): void;
        provision(params: Params$Resource$Partners$Subscriptions$Provision, callback: BodyResponseCallback<Schema$Subscription>): void;
        ...
        resume(params?: Params$Resource$Partners$Subscriptions$Resume, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ResumeSubscriptionResponse>>;
        ...
        resume(params: Params$Resource$Partners$Subscriptions$Resume, options: MethodOptions | BodyResponseCallback<Schema$ResumeSubscriptionResponse>, callback: BodyResponseCallback<Schema$ResumeSubscriptionResponse>): void;
        resume(params: Params$Resource$Partners$Subscriptions$Resume, callback: BodyResponseCallback<Schema$ResumeSubscriptionResponse>): void;
        resume(callback: BodyResponseCallback<Schema$ResumeSubscriptionResponse>): void;
        /**
        ...
        suspend(params?: Params$Resource$Partners$Subscriptions$Suspend, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SuspendSubscriptionResponse>>;
        ...
        suspend(params: Params$Resource$Partners$Subscriptions$Suspend, options: MethodOptions | BodyResponseCallback<Schema$SuspendSubscriptionResponse>, callback: BodyResponseCallback<Schema$SuspendSubscriptionResponse>): void;
        suspend(params: Params$Resource$Partners$Subscriptions$Suspend, callback: BodyResponseCallback<Schema$SuspendSubscriptionResponse>): void;
        suspend(callback: BodyResponseCallback<Schema$SuspendSubscriptionResponse>): void;
        /**
        ...
        undoCancel(params?: Params$Resource$Partners$Subscriptions$Undocancel, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$UndoCancelSubscriptionResponse>>;
        ...
        undoCancel(params: Params$Resource$Partners$Subscriptions$Undocancel, options: MethodOptions | BodyResponseCallback<Schema$UndoCancelSubscriptionResponse>, callback: BodyResponseCallback<Schema$UndoCancelSubscriptionResponse>): void;
        undoCancel(params: Params$Resource$Partners$Subscriptions$Undocancel, callback: BodyResponseCallback<Schema$UndoCancelSubscriptionResponse>): void;
        undoCancel(callback: BodyResponseCallback<Schema$UndoCancelSubscriptionResponse>): void;
    }
    ...
    export class Resource$Partners$Usersessions {
        ...
        generate(params?: Params$Resource$Partners$Usersessions$Generate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GenerateUserSessionResponse>>;
        ...
        generate(params: Params$Resource$Partners$Usersessions$Generate, options: MethodOptions | BodyResponseCallback<Schema$GenerateUserSessionResponse>, callback: BodyResponseCallback<Schema$GenerateUserSessionResponse>): void;
        generate(params: Params$Resource$Partners$Usersessions$Generate, callback: BodyResponseCallback<Schema$GenerateUserSessionResponse>): void;
        generate(callback: BodyResponseCallback<Schema$GenerateUserSessionResponse>): void;
    }
